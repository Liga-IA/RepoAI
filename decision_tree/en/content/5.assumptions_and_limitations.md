...
To learn more about the Random Forest model, visit the corresponding model page.
...
The methods used to implement the techniques mentioned above can be found at [1.decision_tree_classification](../../en/code/1.decision_tree_classification.md).
