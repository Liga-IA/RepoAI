...
Como explicado em [Como determinar o valor de k](../concepts/3.como_determinar_valor_de_k.md), temos as seguintes características de k:
...
> [!NOTE]
> Portanto, podemos entender o viés por meio do mesmo exemplo utilizado em "Underfitting e valores altos de k" na parte conceitual: [Como determinar o valor de k](../concepts/3.como_determinar_valor_de_k.md).
...
> [!NOTE]
> Portanto, podemos entender a variância por meio do mesmo exemplo utilizado em "Overfitting e valores baixos de k" na parte conceitual: [Como determinar o valor de k](../concepts/3.como_determinar_valor_de_k.md).
