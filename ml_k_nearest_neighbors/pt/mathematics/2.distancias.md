## Distâncias
Como explicado na [Seção de Ideias Gerais](./1.ideias_gerais.md), faremos previsões com base na proximidade dos dados no espaço de características. Então, precisamos de formas de calcular as distâncias.
