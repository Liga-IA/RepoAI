...
As explained in [General Ideas Section](./1.general_ideas.md), we will make predictions based on the proximity of data in the feature space. Therefore, we need to calculate distances.
